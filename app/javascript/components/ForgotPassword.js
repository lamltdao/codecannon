...
const ForgotPassword = (props) => {
  ...
  return (
    <Grid container spacing={3} direction="column" className={classes.root}>
      <Grid item>
        <Typography variant="h4">{t('email.forgot_password.msg')}</Typography>
      </Grid>
      <Grid item>
        <Typography variant="h6">{t('email.forgot_password.resend_reminder')}</Typography>
      </Grid>
      <Grid item>
